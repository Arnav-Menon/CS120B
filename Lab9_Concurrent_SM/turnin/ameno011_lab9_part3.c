 ...
 *
 *	LINK TO VIDEO: https://drive.google.com/file/d/1lHOsDLeVjAdTnmjsJBx9fOguIDxzYEnb/view?usp=sharing 
 */
#include <avr/io.h>
#ifdef _SIMULATE_
...
enum SpeakerSM { Home, Output } state4;
