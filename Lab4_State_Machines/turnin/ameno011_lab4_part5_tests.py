...
tests = [
        {'description': 'PINA: 0x00 => PORTB: 0x00, state: "SM1_Fail',
        'steps': [
                {'inputs': [('PINA', 0x00)], 'iterations': 5 },
            ],
        'expected': [('PORTB', 0x00)],
        },
        {'description': 'PINA: 0x03 => PORTB: 0x00, state: "SM1_Fail',
        'steps': [
                {'inputs': [('PINA', 0x03)], 'iterations': 5 },
            ],
        'expected': [('PORTB', 0x00)],
        },
        {'description': 'PINA: 0x04, 0x00, 0x01, 0x00, 0x02, 0x00, 0x01 => PORTB: 0x01, state: SM1_Fail',
        'steps': [ 
                {'inputs': [('PINA', 0x04)], 'iterations': 10 },
                {'inputs': [('PINA', 0x00)], 'iterations': 10 },
                {'inputs': [('PINA', 0x01)], 'iterations': 10 },
                {'inputs': [('PINA', 0x00)], 'iterations': 10 },
                {'inputs': [('PINA', 0x02)], 'iterations': 10 },
                {'inputs': [('PINA', 0x00)], 'iterations': 10 },
                {'inputs': [('PINA', 0x01)], 'iterations': 10 },
            ],
        'expected': [('PORTB', 0x01)],
...
watch = ['state', 'index', 'array[index]', 'PINA', 'PORTB']
